...
# Import Base and models for target_metadata configuration
from src.database.connection import Base
import src.database.models  # Ensures tables are registered on Base.metadata
...
# target_metadata = Base.metadata for autogenerating migrations
